...
async function resetDB() {
    ...
    await sql`CREATE TABLE project_ideas(
            ...
            creator varchar(15) REFERENCES project_idea_users ON DELETE CASCADE
        );`;
    
    await sql`CREATE TABLE project_likes(
        user_id varchar(15) REFERENCES project_idea_users ON DELETE CASCADE,
        project_id integer REFERENCES project_ideas ON DELETE CASCADE,
